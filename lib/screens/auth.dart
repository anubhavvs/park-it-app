...
class _AuthCardState extends State<AuthCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      child: Container(
        height: _authMode == AuthMode.Signup ? 550 : 350,
        color: Colors.white60,
        constraints:
            BoxConstraints(minHeight: _authMode == AuthMode.Signup ? 545 : 345),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                Padding(
                  ...
                  child: Center(
                    child: Container(
                        width: 455,
                        height: 100,
                        child: Image.asset('images/logsh.png')),
                  ),
                ),
                Padding(
                ...
                TextFormField(
                  decoration: InputDecoration(
                    focusColor: Color(0xff298360),
                    labelText: 'Password *',
                    suffixIcon: Icon(Icons.security_outlined,
                        size: 20, color: Color(0xff153084)),
                  ),
                  obscureText: true,
                ...
                if (_authMode == AuthMode.Signup)
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Icon(Icons.security_outlined,
                          size: 18, color: Color(0xff298360)),
                    ),
                    obscureText: true,
                    validator: _authMode == AuthMode.Signup
                        ? (value) {
